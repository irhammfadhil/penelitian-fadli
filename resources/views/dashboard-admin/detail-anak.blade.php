				...
				<div class="container-fluid p-0">
					...
					<div class="card">
						<div class="card-body">
							...
							<br>
							<div class="row">
								<div class="col-3">DMFT: <b>{{$user->dmft_score}}</b></div>
								<div class="col-9">Kriteria DMFT: <b>{{$kriteria_dmft}}</b></div>
							</div>
							<div class="row">
								<div class="col-3">def-t: <b>{{$user->deft_score}}</b></div>
								<div class="col-9">Kriteria def-t: <b>{{$kriteria_deft}}</b></div>
							</div>
